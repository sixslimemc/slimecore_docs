...
Another key aspect of SlimeCore is that it is **deterministic**. If used correctly, **previous world state/datapacks should never affect the outcome of a rebuild/load**; the same set of enabled datapacks will always load exactly the same way.
