...
| `optional` | `boolean` | If `true`: SlimeCore will not require the dependency to be installed--your datapack should be designed to work both with and without the dependency. |
