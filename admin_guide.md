...
Because of this paradigm, frontends practically define how you interact with SlimeCore and SlimeCore-loaded datapacks, and it is primarily their responsibilty to document their methods. With that being said, most frontends should share a base level of functionality and conform to the concepts covered in [Essential Concepts](#essential-concepts).
