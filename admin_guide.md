...
Because of this paradigm, frontends practically define how you interact with SlimeCore and SlimeCore-loaded datapacks; it is primarily the responsibilty of your respective frontend's author to document its methods. With that being said, most frontends should share a base level of functionality and conform to the concepts covered in [Essential Concepts](#essential-concepts).
