...
Importantly, if your datapack is configurable, it should install with sensible default/standard configuration already set; configuration should be an *option* to the user, not a *responsibility*.
