...
In the rare cases where SlimeCore cannot ensure a datapack loads correctly, Datapacks can define a **safe mode** tag, which is called automatically in such cases.
