...
Hooks that notify when pack tags are called. Each of these hooks have a `pre` and `post` variant, called just before or after the relavent tag is called, respectively.
