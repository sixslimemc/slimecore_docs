...
When you download a datapack, it's name will likely already match one of these formats (which means you are good to go). If it does not, you should rename it to do so before installing it into your world. See [Getting Manifest Data](./troubleshooting.md#getting-manifest-data) for getting the relavent information.
