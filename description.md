...
SlimeCore may create a noticable single-tick delay during rebuilding, as well as a much lesser single-tick delay during loading. These delays scale linearly with the amount of enabled SlimeCore-loaded datapacks.
