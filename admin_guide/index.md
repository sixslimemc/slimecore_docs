...
To interact with SlimeCore in-game, you must install a **frontend** datapack. A frontend will provide the user-facing interface and features that SlimeCore itself intentionally doesn't include on it's own.
