...
SlimeCore only automatically detects datapacks with **standard names** (a datapack's name is the name of its .zip file or directory in your world's `/datapacks` directory).
