...
It is a baseline expectation that "pure data" elements of your datapack such as scoreboards, NBT storage, entity tags, etc. are removed entirely. The removal of in-world elements such as entities, blocks, items, etc. is to your discretion.
