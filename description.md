...
SlimeCore is a datapack that serves as a datapack loading framework. It defines a more robust and controllable loading paradigm than the default. *It can be thought of as similar to [Lantern Load](https://github.com/LanternMC/load), but taken multiple steps further.*
