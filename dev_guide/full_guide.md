...
SlimeCore ensures that all dependencies are loaded **before** your datapack, and that all required dependencies are enabled and all installed dependencies are of a compatible version (see below) before your datapack loads at all.
