...
SlimeCore-loaded datapacks with non-standard names will not function properly unless manually accounted for. See [this section](#non-standard-datapack-names) for handling non-standard datapack names.
