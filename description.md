...
Depending on the amount of datapacks, SlimeCore may create a significant single-tick delay during rebuilding, as well as a (much lesser) single-tick delay during loading.
