...
For resources that are files, a simple and effective approach is to have a consistently-named directory in each registry that exclusively contains all applicable private resources (e.g. `<registry>/private/...` or `<registry>/_/...`).
