...
SlimeCore creates significant single-tick delay during rebuilding that scales linearly with the number of SlimeCore-loaded datapacks, as well as a much lesser single-tick delay during loading. Outside of rebuilding and loading, SlimeCore does not run any commands and has negligible performance impact.
