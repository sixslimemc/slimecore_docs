...
- [Less Reading More Datapacks](#less-reading-more-datapacks)
...
7. Use [the SCDev docs](https://github.com/sixslimemc/scdev), [Key Concepts](./key_concepts.md), and [Troubleshooting](./troubleshooting.md) for further reference.
