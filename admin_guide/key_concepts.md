...
Explicitly rebuilding for uninstall not only ensures that your datapack can be safely uninstalled, but also lets the datapack "clean itself up", as to not leave any leftover artifacts or breadcrumbs in your world.
