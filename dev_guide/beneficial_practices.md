...
Importantly, if your datapack is configurable, it should set a sensible default/standard configuration upon installation--configuration should be an *option* to the user, not a *responsibility*.
