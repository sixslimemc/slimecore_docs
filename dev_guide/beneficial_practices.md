...
Importantly, if your datapack is configurable, it should install with sensible default configuration already set; configuration should be an *option* to the user, not a *responsibility*. It is also beneficial to include a function in your datapack that resets configuration back to default.
