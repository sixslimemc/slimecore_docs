...
*Internally, SlimeCore causes minecraft to "soft-reload" many times due to repeated execution of `/datapack`. Each soft-reload takes about the time of a default Minecraft `/reload`.*
