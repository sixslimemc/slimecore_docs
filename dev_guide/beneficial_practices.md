...
It is true that configuration options may allow users to diminish their own experience with your datapack. However, your datapack should automatically provide its own *sensible defaults*; the configuration is left there as an *option*.
