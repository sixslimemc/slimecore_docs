...
> While SlimeCore is still in an early-adoption phase, the selection of frontend datapacks may be sparse. If you wish to contribute, it is not too difficult to [create your own](../interface_guide/index.md).
