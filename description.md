...
In the rare cases where SlimeCore cannot ensure a datapack (and all of it's dependencies) loaded correctly, Datapacks can define a **safe mode** tag, which is called automatically in such cases.
