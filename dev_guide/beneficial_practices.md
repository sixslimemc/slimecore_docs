...
While SlimeCore seeks to be a significant step toward this goal, datapacks' content compatibility and usability contribute just as much, if not more. Even so, SlimeCore intentionally does not try and control such elements, as they are things that *you*, the datapack developer(s), should be in control over.
