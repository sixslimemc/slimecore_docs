...
SlimeCore is a datapack that loads and manages other datapacks. It serves a similar purpose to [Lantern Load](https://github.com/LanternMC/load), but takes it multiple steps further.
