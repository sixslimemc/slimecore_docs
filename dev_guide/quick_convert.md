...
It is likely that your existing datapack already only has one namespace where it defines new resources in--if this is the case, you may skip to the next section.
