...
It is an implicit goal of SlimeCore to make [libraries](./full_guide.md#is_library) more appealing to use and create, however, the decision to use or create any given library should be treated with equal importance as any other core development decision.
