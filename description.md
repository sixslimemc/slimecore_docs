...
Depending on the amount of datapacks, a significant single-tick delay can be expected upon rebuilding, as well as a shorter single-tick delay during loading. Otherwise, SlimeCore does not run any ticking commands and has negligible performance impact.
