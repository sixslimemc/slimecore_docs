...
***In all practical cases (aside from recovering from a [clean rebuild](./troubleshooting.md#clean-rebuilding)), **Using `/datapack` to managing datapack loading is a user-error and may cause unexpected behavior.***
