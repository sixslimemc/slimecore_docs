...
It is a baseline expectation that "pure data" elements of your datapack (scoreboards, NBT storage, entity tags, etc.) are removed entirely. The removal/handling of in-world elements (entities, blocks, items, etc.) is to your discretion.
