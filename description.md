...
SlimeCore is a datapack that loads other datapacks, providing a datapack loading paradigm that is more robust and controllable than the default. It is similar in purpose to [Lantern Load](https://github.com/LanternMC/load), but is taken many steps further.
