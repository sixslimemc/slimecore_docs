...
Scdev sends a message to players with tag `scdev.listen` upon every `/reload` that contains useful information and errors. This is the primary method of gaining troubleshooting information.
