...
It is an implicit goal of SlimeCore to make [libraries](./full_guide.md#is_library) more appealing and accessible to both use and create. However, while libraries are generally encouraged, the decision to use or create any given library should be treated with equal importance as any other core development decision.
