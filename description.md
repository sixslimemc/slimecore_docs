...
Datapacks specify this information in a *manifest* function, and SlimeCore processes all datapacks' manifests, validates relationships, then executes a compatible load/calling order (a *build*). 
