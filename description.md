...
SlimeCore provides a datapack loading system/paradigm that is more robust and controllable than the default--it is a datapack that loads other datapacks. It is similar in purpose to [Lantern Load](https://github.com/LanternMC/load), but is taken many steps further.
