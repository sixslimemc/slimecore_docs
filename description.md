...
The following demonstrates a manifest function that a datapack would add to `#slimecore:manifest`. This is the rough equivalent to a non-SlimeCore-loaded datapack adding to `#minecraft:load`.
