...
- **Pack ID:** A lowercase alphanumeric name that uniquely identifies the datapack within your world. If there is anything to remember about a datapack, it is it's pack ID.
