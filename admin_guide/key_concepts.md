...
- **Pack ID:** A lowercase alphanumeric name that uniquely identifies the datapack within your world. If there is anything to remember about an installed datapack, it is it's pack ID.
