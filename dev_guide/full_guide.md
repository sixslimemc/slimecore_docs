...
For resources that are files, a simple and effective approach is to have a consistently-named directory that exclusively contains all applicable private resources in each registry (e.g. `<registry>/private/...` or `<registry>/_/...`).
