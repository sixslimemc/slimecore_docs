...
A large single-tick delay during a rebuild may occur, as well as a shorter single-tick delay during a load, but otherwise, SlimeCore does not run any ticking commands, and should have zero performance impact after rebuilding/loading.
