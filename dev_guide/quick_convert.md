...
A walkthrough of quickly converting your existing datapack to a SlimeCore-loaded one. These instructions should work for *most* datapacks, but they do not cover all nuances nor do they necessarily represent strict rules. If in doubt, reference the [Full Guide](./full_guide.md).
