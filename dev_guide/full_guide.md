...
For resources that are files, a simple and effective structure scheme is to have a consistent-named directory exclusively for private resources in each registry (e.g. `<registry>/private/...` or `<registry>/_/...`).
