...
| `optional` | `boolean` | If `true`, SlimeCore will not require the dependency to be installed. Your datapack should function regardless of the dependency's presence if so. |
