...
Importantly, if your datapack is configurable, it should automatically provide a sensible default configuration "out of the box"; configuration should be an *option* to the user, not a *responsibility*.
