...
SlimeCore may create a significant single-tick delay (multiple times greater than default Minecraft reloading) during rebuilding, scaling linearly with the amount of SlimeCore-loaded datapacks, as well as a much lesser single-tick delay during loading.
