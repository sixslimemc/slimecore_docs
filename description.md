...
A significant single-tick delay during rebuilds may occur, as well as a shorter single-tick delay during loads, but otherwise, SlimeCore does not run any ticking commands and has zero performance impact.
